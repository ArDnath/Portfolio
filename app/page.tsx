...
export default function Home() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] min-h-[calc(100vh-2rem)] lg:h-[calc(100vh-2rem)] lg:overflow-hidden gap-4 bg-background text-foreground transition-colors duration-150 pb-8 lg:pb-0">
